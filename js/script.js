...
window.addEventListener('mousemove', e => {
  ...
  heroContent.style.transform = `translate(${x/1.5}px, ${y/1.5}px)`;
  motif.style.transform = `translate(${x}px, ${y}px) rotate(${x}deg)`;
});
...
// Hero background color on scroll
...
// ==========================
// PROJECTS (Hover 3D + Parallax + Modal)
// ==========================
